...
# NSE Sector indices for M5 (Yahoo Finance tickers)
SECTOR_INDICES = [
    '^CNXIT',      # Nifty IT
    '^NSEBANK',    # Nifty Bank (Yahoo; formerly ^CNXBANK)
    '^CNXAUTO',    # Nifty Auto
    '^CNXFMCG',    # Nifty FMCG
...
NIFTY500_UNIVERSE = [
    ...
    'TMPV.NS', 'BAJFINANCE.NS', 'ADANIENT.NS', 'TITAN.NS', 'SUNPHARMA.NS',
    ...
    'TATACONSUM.NS', 'INDUSINDBK.NS', 'SHRIRAMFIN.NS', 'DMART.NS', 'ETERNAL.NS',
