...
# Support both `from model.module import *` (original repo layout) and
# the vendored layout where this file lives in kronos_model/
_this_dir = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, os.path.dirname(_this_dir))
try:
    from model.module import *          # noqa: F401,F403  (original repo layout)
except ModuleNotFoundError:
    from kronos_model.module import *   # vendored layout inside scanner/
